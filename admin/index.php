    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">AdminGatget.In</a> 
            </div>
  <div style="color: white;
padding: 15px 50px 5px 50px;
float: right;
font-size: 16px;"><?php echo "Last access :" . date("d-m-y"); ?>  &nbsp; <a href="login.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        </nav>   
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a href="../index.php"><i class="fa fa-bolt fa-3x" style="font-size:36px"></i> Store</a>
                    </li>
                    <li>
                        <a href="login.php"><i class="glyphicon glyphicon-log-in" style="font-size:36px"></i> Logout</a>
                    </li>
                </ul>
            </div>
                </ul>
